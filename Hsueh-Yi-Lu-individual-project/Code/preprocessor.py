...
# data_health.iloc[:, 1:-1] = data_health.iloc[:, 1:-1].apply(lambda x: x.fillna(x.value_counts().index[0]))
# data_clean.iloc[:, 1:-1] = data_clean.iloc[:, 1:-1].apply(lambda x: x.fillna(x.value_counts().index[0]))
# data_pollution.iloc[:, 1:-1] = data_pollution.iloc[:, 1:-1].apply(lambda x: x.fillna(x.value_counts().index[0]))
# data_GDP.iloc[:, 1:-1] = data_GDP.iloc[:, 1:-1].apply(lambda x: x.fillna(x.value_counts().index[0]))
# data_energy.iloc[:, 1:-1] = data_energy.iloc[:, 1:-1].apply(lambda x: x.fillna(x.value_counts().index[0]))
