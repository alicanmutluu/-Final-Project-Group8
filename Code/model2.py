...
# alternative model from generated feature, R-squared is not good
'''
out_data2=out_data[out_data['Energy from coal per capita']>0]
out_data2['GDP/coal']=out_data['GDP per capita (in USD)']/out_data['Energy from coal per capita']
out_data2['GDP/oil']=out_data['GDP per capita (in USD)']/out_data['Energy from oil per capita']
out_data2['Outdoor particulate matter (deaths per 100,000)']=out_data2['Outdoor particulate matter (deaths per 100,000)'].map(lambda x: np.log(x))
model3=LinearRegression()
model3.fit(out_data2[['GDP/coal','GDP/oil','GDP per capita (in USD)']],out_data2['Outdoor particulate matter (deaths per 100,000)'])
'''
print(model3.score(out_data2[['GDP/coal','GDP/oil','GDP per capita (in USD)']],out_data2['Outdoor particulate matter (deaths per 100,000)']))